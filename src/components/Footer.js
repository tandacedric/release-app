...
<footer class="w-100 py-4 flex-shrink-0">
    <div style={{paddingLeft: "7%",paddingRight: "7%"}} class="container-fluid text-left py-4">
        <div class="row gy-4 gx-5">
            <div class="col-lg-4 col-md-4">
                <h5 class="h1 text-white title-font">Release Money</h5>
                <p class=" text-white title-font-2">Partenaires spécial des entreprises camerounaise dans des besoins financiers</p>
                <p class=" text-white mb-0 title-font-2">&copy; Copyright. Tous droits réservés <a class="text-primary" href="/">ETS RELEASE</a></p>
            </div>
            ...
            <div class="col-lg-3 col-md-3">
                ...
                <p class="text-white title-font-2">Carefour Dounier, Manassa, Nfou</p>
            ...
            <div class="col-lg-3 col-md-3">
                ...
                <p class="text-white title-font-2">Samedi et jours fériés: 09h-14h</p>
            </div>
        </div>
    </div>
</footer>
